...
I_haze_train_loader = DataLoader(dataset = RESIDE_Dataset(path + 'i-haze/I-HAZE/train', train = True), 
                             batch_size = BS, shuffle = True)

I_haze_test_loader = DataLoader(dataset = RESIDE_Dataset(path + 'i-haze/I-HAZE/val', train = False), 
                             batch_size = 1, shuffle = False)
